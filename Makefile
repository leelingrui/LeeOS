...
KERNEL_FILES:=$(KERNEL_SRC)/lib.rs $(KERNEL_SRC)/kernel/console.rs $(KERNEL_SRC)/kernel/interrupt.rs $(KERNEL_SRC)/kernel/io.rs $(KERNEL_SRC)/kernel/lang_items.rs \
	...
	$(KERNEL_SRC)/kernel/keyboard.rs $(KERNEL_SRC)/kernel/rtc.rs $(KERNEL_SRC)/kernel/input.rs $(KERNEL_SRC)/crypto/mod.rs $(KERNEL_SRC)/crypto/crc32c.rs $(KERNEL_SRC)/crypto/crc16.rs \
	$(KERNEL_SRC)/crypto/crc32table.rs
